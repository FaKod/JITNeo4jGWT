...
public class ProxyServlet extends HttpServlet {
    ...
    public void init(ServletConfig servletConfig) {
        ...
        // Remove Prefix
        String stringremovePrefix = servletConfig.getInitParameter("removePrefix");
        if (stringremovePrefix != null && stringremovePrefix.length() > 0) {
            this.setRemovePrefix(Boolean.parseBoolean(stringremovePrefix));
        }
    }
